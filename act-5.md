...
<img src="images/act-5/0.png" alt="bo-o-o-o-one?!" style="float:right;width:240px;margin-left:10px;">
...
6.  Export as separate STL files:
    ...
    <img src="images/act-5/6.png" alt="save as stl" style="float:right;width:180px;margin-left:10px;">
...
2.  Make a hole in the other side of the femur:
    ...
    <img src="images/act-5/p2-3.png" alt="hole" style="float:right;width:220px;margin-left:10px;">
