...
3.  Sketch dimensioning
    ...
    <img src="images/act-1/3-2b.png" alt="bad sketch" style="float:right;width:180px;margin-left:10px;">
    ...
    <img src="images/act-1/3b.png" alt="good sketch" style="float:right;width:180px;margin-left:10px;">
