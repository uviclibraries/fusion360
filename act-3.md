...
12.  Fillet internal corners underneath the lego piece. This makes it easier to print without supports since the eventual overhang of the top of the brick will be printed over a smaller distance if the internal walls have recently begun to slope inwards.
