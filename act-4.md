...
6.  Make the metal pin:
    ...
    -   **Click** on the **Extrude** feature <img src="images/act-4/6-2.png" alt="extrude feature" style="width:25px;">. In the Extrude pop-up box, **enter 15 mm** as the **Distance. Click OK.**
